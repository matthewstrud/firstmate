...
`/updatefirstmate` updates each remote code root from that checkout's own update remote, then guardedly fast-forwards the persistent remote home to that code-root commit.
